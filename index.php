...
if (isset($_POST['login'])) {
    ...
    $rowLogin = mysqli_fetch_assoc($login); //mysqli_fetch_assoc akan menjadi data dari hasil quey

    // $dataNama = "anton asoy";
    // $dataEmail = "bejo@gmail.com";
    // $dataPassword = "123";
...
<head>
    ...
    <!-- Page CSS -->
    <!-- Page -->
    <link rel="stylesheet" href="assets/template/assets/vendor/css/pages/page-auth.css" />
    <!-- Helpers -->
...
<body>
    ...
    <script src="assets/template/assets/vendor/libs/jquery/jquery.js"></script>
    <script src="assets/template/assets/vendor/libs/popper/popper.js"></script>
    <script src="assets/template/assets/vendor/js/bootstrap.js"></script>
    <script src="assets/template/assets/vendor/libs/perfect-scrollbar/perfect-scrollbar.js"></script>
